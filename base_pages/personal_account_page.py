...
class AccountPage(BasePage):
    ...
    def go_to_personal_account(self):
        ...
        self.clicks(Locators_account.personal_account)  # Используем метод clicks из BasePage
        self.clicks(Locators_account.entrance)  # Используем метод clicks из BasePage
